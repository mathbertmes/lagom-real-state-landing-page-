...
const PlantsSection = () => {
  ...
  return (
    <Container>
      <div id="layouts-section" className="max-w-7xl mx-auto pb-14">
        <div className="w-full flex flex-col lg:flex-row justify-between items-center">
          ...
          <p className="max-w-[400px] text-sm px-4 lg:px-0">
            Navegue pelas plantas e imagine-se vivendo em um ambiente que combina sofisticação, inovação e conforto. Descubra o seu novo lar e transforme seus sonhos em realidade.
          </p>
        </div>
        <div className="flex flex-col lg:flex-row lg:items-center w-full lg:justify-between">
          ...
          <div className={`transition-opacity duration-300 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
            <div id="options" className="flex justify-center mt-10 mb-10">
              <div>
                <Label className="font-semibold">Selecione o tipo de planta:</Label>
                {condominio === 0 ? (
                  <Select value={selectedValueMassala} onValueChange={(value) => handleChangeMassala(value)}>
                  ...
                  <Select value={selectedValueMirra} onValueChange={(value) => handleChangeMirra(value)}>
                    <SelectTrigger className="w-[250px]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="w-[250px]">
